...
-- Nieokreślone wyrażenie, czyli takie bez typu
...
-- Konwertuje wyrażenie okreslone na typ nieokreslony.
...
-- Konwertuje wyrażenie nieokreślone na typ określony zrozumiały przez interperter.
...
instance Arbitrary Natural where
    arbitrary = sized $ \n -> inBounds naturalFromInteger (choose (0, toInteger n))
...
charEqu = '='; textEqu = W.singleton charEqu
